...
The loader and runner code for this tree lives in:

- `backend/internal/controller/eval/loader.go`
- `backend/internal/controller/eval/runner.go`
- `backend/internal/controller/evaluation/runner.go`
