...
describe('JointRiskPage', () => {
    ...
    it('renders time-series and ranked risk drilldowns', async () => {
        ...
        expect(await screen.findByText('Investigation Events')).toBeInTheDocument();
        ...
        expect((await screen.findAllByText(/co-occurred within window/)).length).toBeGreaterThan(0);
    });
