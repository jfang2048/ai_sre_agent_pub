            ...
            reports: [
                {
                    ...
                    agent_loop: {
                        ...
                        plan_steps: [
                            ...
                            },
                            {
                                ...
                                required: false,
                                status: 'completed',
                                result_summary: 'knowledge retrieval returned no matching evidence',
                                verified: false,
                                verification_note: 'knowledge retrieval returned no matching evidence',
                    ...
                    structured_report: {
                        ...
                        confidence: 0.82,
                        unresolved_gaps: ['knowledge retrieval did not return corroborating evidence'],
                    ...
                    reproducibility: {
                        pipeline: 'v0.6-workflow-pipeline',
                        deterministic: 'true',
                    },
                    unresolved_gaps: ['knowledge retrieval did not return corroborating evidence'],
                    limitations: [],
