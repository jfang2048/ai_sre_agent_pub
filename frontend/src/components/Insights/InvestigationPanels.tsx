                    ...
                    {rows.map((trend) => (
                        <article key={trend.id} className="rounded border border-border bg-background/50 p-3">
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <div className={`rounded-full border px-2 py-0.5 text-[11px] uppercase tracking-wide ${severityTone(trend.severity)}`}>
                                    {trend.severity}
                                </div>
                            </div>
                    ...
                    {rows.map((event) => (
                        <article key={event.id} className="rounded border border-border bg-background/50 p-3">
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <div className={`rounded-full border px-2 py-0.5 text-[11px] uppercase tracking-wide ${severityTone(event.severity)}`}>
                                    {event.severity}
                                </div>
                            </div>
