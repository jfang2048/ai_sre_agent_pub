...
CONTROLLER_IMAGE="${SRE_CONTROLLER_IMAGE:-ai-sre-agent/controller:${SRE_VERSION:-v0.6}}"
COLLECTOR_IMAGE="${SRE_COLLECTOR_IMAGE:-ai-sre-agent/collector:${SRE_VERSION:-v0.6}}"
