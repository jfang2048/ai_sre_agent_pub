...
CONTROLLER_IMAGE="${SRE_CONTROLLER_IMAGE:-ai-sre-agent/controller:${SRE_VERSION:-$(repo_version "${ROOT_DIR}")}}"
COLLECTOR_IMAGE="${SRE_COLLECTOR_IMAGE:-ai-sre-agent/collector:${SRE_VERSION:-$(repo_version "${ROOT_DIR}")}}"
