...
This page explains how to read the current Web UI as an investigation console instead of a generic dashboard. It uses the actual `v0.8` pages, the refreshed screenshots under [`docs/images/`](../images/), and the code that renders them.
