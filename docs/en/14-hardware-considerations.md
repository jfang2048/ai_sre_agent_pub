...
This page explains how `v0.7` treats hardware as part of observability logic instead of assuming every host behaves like the same generic machine.
...
| [`docs/reference/metrics.md`](../reference/metrics.md) | exported hardware-related metric families |
