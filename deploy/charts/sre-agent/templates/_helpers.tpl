...
{{- define "sre-agent.collectorPrivilegeProfile" -}}
{{- default "deep-runtime" .Values.collector.privilegeProfile -}}
{{- end -}}

{{- define "sre-agent.collectorHostPID" -}}
{{- if eq (include "sre-agent.collectorPrivilegeProfile" .) "deep-runtime" -}}true{{- else -}}false{{- end -}}
{{- end -}}

{{- define "sre-agent.collectorMountHostSys" -}}
{{- if ne (include "sre-agent.collectorPrivilegeProfile" .) "minimal" -}}true{{- else -}}false{{- end -}}
{{- end -}}

{{- define "sre-agent.collectorMountHostLogs" -}}
{{- $profile := include "sre-agent.collectorPrivilegeProfile" . -}}
{{- if or (eq $profile "observability") (eq $profile "deep-runtime") -}}true{{- else -}}false{{- end -}}
{{- end -}}

{{- define "sre-agent.collectorMountKernelDebug" -}}
{{- if eq (include "sre-agent.collectorPrivilegeProfile" .) "deep-runtime" -}}true{{- else -}}false{{- end -}}
{{- end -}}

{{- define "sre-agent.collectorMountBPFFS" -}}
{{- if eq (include "sre-agent.collectorPrivilegeProfile" .) "deep-runtime" -}}true{{- else -}}false{{- end -}}
{{- end -}}

{{- define "sre-agent.collectorMountKernelModules" -}}
{{- if eq (include "sre-agent.collectorPrivilegeProfile" .) "deep-runtime" -}}true{{- else -}}false{{- end -}}
{{- end -}}
