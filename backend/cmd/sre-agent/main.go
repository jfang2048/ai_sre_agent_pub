...
import (
	...
	"github.com/jfang2048/ai_sre_agent_pub/internal/controller/core"
...
func main() {
	...
	rootCmd.Flags().StringVar(&controllerURL, "controller", "", "URL of the SRE controller to push metrics/logs to")
...
func runAgent(cmd *cobra.Command, args []string) {
	...
	if controllerURL != "" {
		cfg.Server.ControllerURL = controllerURL
	}
