// Package logindex parses JSON, syslog, common, and combined access logs for the native index.
package logindex
...
// ParseTimestamp accepts Unix epochs, RFC timestamps, and common syslog or access-log layouts.
...
func ExtractLevel(text string) string {
	...
	// Specific words are checked before generic substrings such as "err".
