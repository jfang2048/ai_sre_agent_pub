...
func TestBuildContextBundleForRCA(t *testing.T) {
	...
	// For high-risk RCA workflows, the mode should be plan_review_refine or full_iterative.
	require.Contains(t, []string{"plan_review_refine", "full_iterative", "single_pass"}, report.LLMAnalysis.Review.Mode)
	require.NotEmpty(t, report.LLMAnalysis.Reasoning.Plan)
