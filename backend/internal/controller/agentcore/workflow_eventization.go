...
func buildTrendAssessments(collectorID string, series []RiskSeries, current map[string]float64, history []ingest.MetricHistorySample, window time.Duration) []TrendAssessment {
