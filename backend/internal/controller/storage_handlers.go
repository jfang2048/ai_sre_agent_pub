...
func (c *Controller) handleStorageStatus(w http.ResponseWriter, r *http.Request) {
	...
	if c.timeseriesService != nil {
		resp["tsdb"] = c.timeseriesService.Status()
	}
	if c.logIndex != nil {
...
func (c *Controller) timeseriesStatus() interface{} {
	if c == nil || c.timeseriesService == nil {
		return nil
	}
	return c.timeseriesService.Status()
}
