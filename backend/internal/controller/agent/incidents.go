...
func (e *Engine) assessContextLocked(ctx incidents.AggregatedContext) IncidentAssessment {
	...
	automation := buildAutomationPlan(ctx, sev, runbooks)
...
func buildAutomationPlan(ctx incidents.AggregatedContext, sev string, runbooks []RunbookLink) IncidentAutomationPlan {
