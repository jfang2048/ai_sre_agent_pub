...
func convertProbeCoreBatch(batch *probeipcv1.ProbeBatch, fallbackNow time.Time, emitRawAliasedMetrics bool) ([]*telemetryv1.Metric, []*telemetryv1.ProcessSample) {
	if batch == nil {
		return nil, nil
	}
	...
	for _, metric := range batch.GetMetrics() {
		...
		labelsMap := normalizeProbeCoreLabels(probeCoreLabelsMap(metric.GetLabels()))
		labels := buildLabels(labelsMap)
		if emitRawAliasedMetrics || !probeCoreMetricHasAlias(name) {
		...
		case "probe_core_ebpf_socket_connected":
			metrics = append(metrics, newAliasedMetric("node_ebpf_socket_connected", value, ts, labelsMap))
		case "probe_core_ebpf_receiver_running":
			metrics = append(metrics, newAliasedMetric("node_ebpf_receiver_running", value, ts, labelsMap))
		case "probe_core_ebpf_events_total":
			metrics = append(metrics, newAliasedMetric("node_ebpf_events_total", value, ts, labelsMap))
		case "probe_core_ebpf_events_rate":
			metrics = append(metrics, newAliasedMetric("node_ebpf_events_rate", value, ts, labelsMap))
		case "probe_core_ebpf_events_bytes_total":
			metrics = append(metrics, newAliasedMetric("node_ebpf_events_bytes_total", value, ts, labelsMap))
		case "probe_core_ebpf_events_bytes_rate":
			metrics = append(metrics, newAliasedMetric("node_ebpf_events_bytes_rate", value, ts, labelsMap))
		case "probe_core_ebpf_events_latency_seconds_avg":
			metrics = append(metrics, newAliasedMetric("node_ebpf_events_latency_seconds_avg", value, ts, labelsMap))
		case "probe_core_ebpf_category_events_total":
			metrics = append(metrics, newAliasedMetric("node_ebpf_category_events_total", value, ts, labelsMap))
		case "probe_core_ebpf_category_events_rate":
			metrics = append(metrics, newAliasedMetric("node_ebpf_category_events_rate", value, ts, labelsMap))
		case "probe_core_ebpf_category_bytes_per_second":
			metrics = append(metrics, newAliasedMetric("node_ebpf_category_bytes_per_second", value, ts, labelsMap))
		case "probe_core_ebpf_network_flow_bytes_per_second":
			metrics = append(metrics,
				newAliasedMetric("node_network_flow_ebpf_bytes_per_second", value, ts, labelsMap),
				newAliasedMetric("rca_net_ebpf_flow_bytes_per_second", value, ts, labelsMap),
			)
		case "probe_core_ebpf_syscall_latency_seconds_avg":
			metrics = append(metrics, newAliasedMetric("rca_syscall_latency_seconds_avg", value, ts, labelsMap))
		case "probe_core_ebpf_sched_contention_events_per_second":
			metrics = append(metrics, newAliasedMetric("rca_cpu_sched_contention_events_per_second", value, ts, labelsMap))
		case "probe_core_ebpf_io_latency_seconds_avg":
			metrics = append(metrics, newAliasedMetric("rca_io_latency_seconds_avg", value, ts, labelsMap))
		case "probe_core_ebpf_process_events_total":
			metrics = append(metrics, newAliasedMetric("rca_ebpf_process_events_total", value, ts, labelsMap))
		case "probe_core_ebpf_process_events_rate":
			metrics = append(metrics, newAliasedMetric("rca_ebpf_process_events_rate", value, ts, labelsMap))
		case "probe_core_ebpf_process_bytes_total":
			metrics = append(metrics, newAliasedMetric("rca_ebpf_process_bytes_total", value, ts, labelsMap))
		case "probe_core_ebpf_process_bytes_rate":
			metrics = append(metrics, newAliasedMetric("rca_ebpf_process_bytes_rate", value, ts, labelsMap))
		case "probe_core_ebpf_process_latency_seconds_avg":
			metrics = append(metrics, newAliasedMetric("rca_ebpf_process_latency_seconds_avg", value, ts, labelsMap))
		...
		case "probe_core_gpu_count":
			metrics = append(metrics, newAliasedMetric("node_gpu_count", value, ts, labelsMap))
		case "probe_core_gpu_info":
			metrics = append(metrics, newAliasedMetric("node_gpu_info", value, ts, labelsMap))
		...
		case "probe_core_gpu_utilization_sm_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_utilization_sm_percent", value, ts, labelsMap))
		case "probe_core_gpu_utilization_memory_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_utilization_memory_percent", value, ts, labelsMap))
		case "probe_core_gpu_memory_used_mb":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_used_mib", value, ts, labelsMap))
		case "probe_core_gpu_memory_used_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_used_mib", value, ts, labelsMap))
		case "probe_core_gpu_memory_total_mb":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_total_mib", value, ts, labelsMap))
		case "probe_core_gpu_memory_total_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_total_mib", value, ts, labelsMap))
		case "probe_core_gpu_memory_free_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_free_mib", value, ts, labelsMap))
		case "probe_core_gpu_memory_used_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_memory_used_percent", value, ts, labelsMap))
		case "probe_core_gpu_temperature_c":
			metrics = append(metrics, newAliasedMetric("node_gpu_temperature_celsius", value, ts, labelsMap))
		case "probe_core_gpu_temperature_celsius":
			metrics = append(metrics, newAliasedMetric("node_gpu_temperature_celsius", value, ts, labelsMap))
		case "probe_core_gpu_power_watts":
			metrics = append(metrics, newAliasedMetric("node_gpu_power_draw_watts", value, ts, labelsMap))
		case "probe_core_gpu_power_draw_watts":
			metrics = append(metrics, newAliasedMetric("node_gpu_power_draw_watts", value, ts, labelsMap))
		case "probe_core_gpu_power_limit_watts":
			metrics = append(metrics, newAliasedMetric("node_gpu_power_limit_watts", value, ts, labelsMap))
		case "probe_core_gpu_pcie_gen":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_gen", value, ts, labelsMap))
		case "probe_core_gpu_pcie_width":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_width", value, ts, labelsMap))
		case "probe_core_gpu_pcie_gen_max":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_gen_max", value, ts, labelsMap))
		case "probe_core_gpu_pcie_width_max":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_width_max", value, ts, labelsMap))
		case "probe_core_gpu_pcie_rx_mb_s":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_rx_mb_s", value, ts, labelsMap))
		case "probe_core_gpu_pcie_tx_mb_s":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_tx_mb_s", value, ts, labelsMap))
		case "probe_core_gpu_pcie_bandwidth_theoretical_mb_s":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_bandwidth_theoretical_mb_s", value, ts, labelsMap))
		case "probe_core_gpu_pcie_bandwidth_max_mb_s":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_bandwidth_max_mb_s", value, ts, labelsMap))
		case "probe_core_gpu_pcie_rx_utilization_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_rx_utilization_percent", value, ts, labelsMap))
		case "probe_core_gpu_pcie_tx_utilization_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_tx_utilization_percent", value, ts, labelsMap))
		case "probe_core_gpu_pcie_link_utilization_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_pcie_link_utilization_percent", value, ts, labelsMap))
		case "probe_core_gpu_bar1_memory_total_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_bar1_memory_total_mib", value, ts, labelsMap))
		case "probe_core_gpu_bar1_memory_used_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_bar1_memory_used_mib", value, ts, labelsMap))
		case "probe_core_gpu_bar1_memory_free_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_bar1_memory_free_mib", value, ts, labelsMap))
		case "probe_core_gpu_process_count":
			metrics = append(metrics, newAliasedMetric("node_gpu_process_count", value, ts, labelsMap))
		case "probe_core_gpu_context_count":
			metrics = append(metrics, newAliasedMetric("node_gpu_context_count", value, ts, labelsMap))
		case "probe_core_gpu_kernel_active_contexts":
			metrics = append(metrics, newAliasedMetric("node_gpu_kernel_active_contexts", value, ts, labelsMap))
		case "probe_core_gpu_ecc_single_bit_errors_total":
			metrics = append(metrics, newAliasedMetric("node_gpu_ecc_single_bit_errors_total", value, ts, labelsMap))
		case "probe_core_gpu_ecc_double_bit_errors_total":
			metrics = append(metrics, newAliasedMetric("node_gpu_ecc_double_bit_errors_total", value, ts, labelsMap))
		case "probe_core_gpu_throttle_active_any":
			metrics = append(metrics, newAliasedMetric("node_gpu_throttle_active_any", value, ts, labelsMap))
		case "probe_core_gpu_throttle_thermal_any":
			metrics = append(metrics, newAliasedMetric("node_gpu_throttle_thermal_any", value, ts, labelsMap))
		case "probe_core_gpu_throttle_power_any":
			metrics = append(metrics, newAliasedMetric("node_gpu_throttle_power_any", value, ts, labelsMap))
		case "probe_core_gpu_throttle_idle":
			metrics = append(metrics, newAliasedMetric("node_gpu_throttle_idle_active", value, ts, labelsMap))
		case "probe_core_gpu_nvlink_links":
			metrics = append(metrics, newAliasedMetric("node_gpu_nvlink_links", value, ts, labelsMap))
		case "probe_core_gpu_energy_consumption_joules":
			metrics = append(metrics, newAliasedMetric("node_gpu_energy_consumption_joules", value, ts, labelsMap))
		...
		case "probe_core_gpu_process_memory_mib":
			metrics = append(metrics, newAliasedMetric("node_gpu_process_memory_mib", value, ts, labelsMap))
		case "probe_core_gpu_process_mem_util_percent":
			metrics = append(metrics, newAliasedMetric("node_gpu_process_mem_util_percent", value, ts, labelsMap))
		case "probe_core_gpu_process_context_active":
			metrics = append(metrics, newAliasedMetric("node_gpu_process_context_active", value, ts, labelsMap))
...
func normalizeProbeCoreLabels(labels map[string]string) map[string]string {
	if len(labels) == 0 {
		return labels
	}
	if gpu := strings.TrimSpace(labels["gpu"]); gpu != "" && strings.TrimSpace(labels["gpu_id"]) == "" {
		labels["gpu_id"] = gpu
	}
	if uuid := strings.TrimSpace(labels["gpu_uuid"]); uuid != "" && strings.TrimSpace(labels["uuid"]) == "" {
		labels["uuid"] = uuid
	}
	if process := strings.TrimSpace(labels["process_name"]); process != "" && strings.TrimSpace(labels["process"]) == "" {
...
func probeCoreMetricHasAlias(name string) bool {
	switch name {
	case "probe_core_loadavg_1m",
		"probe_core_loadavg_5m",
		"probe_core_loadavg_15m",
		"probe_core_cpu_usage_percent",
		"probe_core_sched_context_switches_total",
		"probe_core_sched_running_tasks",
		"probe_core_sched_blocked_tasks",
		"probe_core_memory_total_bytes",
		"probe_core_memory_available_bytes",
		"probe_core_memory_used_bytes",
		"probe_core_memory_used_percent",
		"probe_core_memory_cached_bytes",
		"probe_core_memory_buffers_bytes",
		"probe_core_swap_total_bytes",
		"probe_core_swap_free_bytes",
		"probe_core_vm_pgfault_total",
		"probe_core_vm_pgmajfault_total",
		"probe_core_vm_pgscan_kswapd_total",
		"probe_core_vm_pgsteal_kswapd_total",
		"probe_core_disk_read_bytes_per_sec",
		"probe_core_disk_write_bytes_per_sec",
		"probe_core_disk_reads_per_sec",
		"probe_core_disk_writes_per_sec",
		"probe_core_disk_await_ms",
		"probe_core_disk_queue_depth",
		"probe_core_disk_queue_capacity",
		"probe_core_network_rx_bytes_per_sec",
		"probe_core_network_tx_bytes_per_sec",
		"probe_core_network_rx_packets_per_sec",
		"probe_core_network_tx_packets_per_sec",
		"probe_core_network_rx_drops_total",
		"probe_core_network_tx_drops_total",
		"probe_core_network_rx_errors_total",
		"probe_core_network_tx_errors_total",
		"probe_core_network_tcp_retransmissions_total",
		"probe_core_network_tcp_retransmissions_per_sec",
		"probe_core_network_softnet_dropped_total",
		"probe_core_network_softnet_squeezed_total",
		"probe_core_netlink_tx_queue_len",
		"probe_core_network_link_up",
		"probe_core_network_speed_mbps",
		"probe_core_ebpf_socket_connected",
		"probe_core_ebpf_receiver_running",
		"probe_core_ebpf_events_total",
		"probe_core_ebpf_events_rate",
		"probe_core_ebpf_events_bytes_total",
		"probe_core_ebpf_events_bytes_rate",
		"probe_core_ebpf_events_latency_seconds_avg",
		"probe_core_ebpf_category_events_total",
		"probe_core_ebpf_category_events_rate",
		"probe_core_ebpf_category_bytes_per_second",
		"probe_core_ebpf_network_flow_bytes_per_second",
		"probe_core_ebpf_syscall_latency_seconds_avg",
		"probe_core_ebpf_sched_contention_events_per_second",
		"probe_core_ebpf_io_latency_seconds_avg",
		"probe_core_ebpf_process_events_total",
		"probe_core_ebpf_process_events_rate",
		"probe_core_ebpf_process_bytes_total",
		"probe_core_ebpf_process_bytes_rate",
		"probe_core_ebpf_process_latency_seconds_avg",
		"probe_core_rdma_ports",
		"probe_core_rdma_port_state",
		"probe_core_rdma_port_phys_state",
		"probe_core_rdma_port_link_rate_gbps",
		"probe_core_rdma_port_transmit_words_total",
		"probe_core_rdma_port_receive_words_total",
		"probe_core_rdma_port_transmit_packets_total",
		"probe_core_rdma_port_receive_packets_total",
		"probe_core_rdma_port_transmit_discards_total",
		"probe_core_rdma_port_receive_errors_total",
		"probe_core_rdma_port_symbol_errors_total",
		"probe_core_rdma_port_link_downed_total",
		"probe_core_rdma_port_link_recovery_total",
		...
		"probe_core_rdma_port_congestion_counter_total",
		"probe_core_rdma_port_transmit_bytes_per_second",
		"probe_core_rdma_port_receive_bytes_per_second",
		"probe_core_rdma_port_errors_per_second",
		"probe_core_rdma_port_congestion_events_per_second",
		"probe_core_rdma_port_pfc_pause_frames_per_second",
		"probe_core_rdma_port_ecn_marked_ratio",
		"probe_core_rdma_port_utilization_percent",
		"probe_core_rdma_errors_per_second",
		"probe_core_rdma_congestion_events_per_second",
		"probe_core_rdma_pfc_pause_frames_per_second",
		"probe_core_rdma_ecn_marked_ratio",
		"probe_core_gpu_count",
		"probe_core_gpu_info",
		"probe_core_gpu_utilization_percent",
		"probe_core_gpu_utilization_sm_percent",
		"probe_core_gpu_utilization_memory_percent",
		"probe_core_gpu_memory_used_mb",
		"probe_core_gpu_memory_used_mib",
		"probe_core_gpu_memory_total_mb",
		"probe_core_gpu_memory_total_mib",
		"probe_core_gpu_memory_free_mib",
		"probe_core_gpu_memory_used_percent",
		"probe_core_gpu_temperature_c",
		"probe_core_gpu_temperature_celsius",
		"probe_core_gpu_power_watts",
		"probe_core_gpu_power_draw_watts",
		"probe_core_gpu_power_limit_watts",
		"probe_core_gpu_pcie_gen",
		"probe_core_gpu_pcie_width",
		"probe_core_gpu_pcie_gen_max",
		"probe_core_gpu_pcie_width_max",
		"probe_core_gpu_pcie_rx_mb_s",
		"probe_core_gpu_pcie_tx_mb_s",
		"probe_core_gpu_pcie_bandwidth_theoretical_mb_s",
		"probe_core_gpu_pcie_bandwidth_max_mb_s",
		"probe_core_gpu_pcie_rx_utilization_percent",
		"probe_core_gpu_pcie_tx_utilization_percent",
		"probe_core_gpu_pcie_link_utilization_percent",
		"probe_core_gpu_bar1_memory_total_mib",
		"probe_core_gpu_bar1_memory_used_mib",
		"probe_core_gpu_bar1_memory_free_mib",
		"probe_core_gpu_process_count",
		"probe_core_gpu_context_count",
		"probe_core_gpu_kernel_active_contexts",
		"probe_core_gpu_ecc_single_bit_errors_total",
		"probe_core_gpu_ecc_double_bit_errors_total",
		"probe_core_gpu_throttle_active_any",
		"probe_core_gpu_throttle_thermal_any",
		"probe_core_gpu_throttle_power_any",
		"probe_core_gpu_throttle_idle",
		"probe_core_gpu_nvlink_links",
		"probe_core_gpu_energy_consumption_joules",
		"probe_core_gpu_process_memory_used_mb",
		"probe_core_gpu_process_memory_mib",
		"probe_core_gpu_process_mem_util_percent",
		"probe_core_gpu_process_context_active",
		"probe_core_process_cpu_percent",
		"probe_core_process_rss_bytes",
		"probe_core_process_io_read_bps",
		"probe_core_process_io_write_bps",
		"probe_core_process_pss_bytes",
		"probe_core_process_page_faults_total",
		"probe_core_process_sched_run_seconds_total",
		"probe_core_process_sched_wait_seconds_total",
		"probe_core_process_sched_wait_ratio",
		"probe_core_process_block_io_delay_seconds_total",
		"probe_core_process_block_io_delay_seconds_per_second",
		"probe_core_process_socket_connections",
		"probe_core_process_socket_tx_queue_bytes",
		"probe_core_process_socket_rx_queue_bytes":
		return true
	default:
		_, _, ok := aliasProbeCorePressureMetric(name, 0)
		return ok
	}
}
