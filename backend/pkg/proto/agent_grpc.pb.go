...
const (
	CollectorService_Register_FullMethodName      = "/api.proto.CollectorService/Register"
	CollectorService_StreamMetrics_FullMethodName = "/api.proto.CollectorService/StreamMetrics"
)
...
type CollectorServiceClient interface {
	...
	StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[MetricBatch, Command], error)
}
...
func (c *collectorServiceClient) StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[MetricBatch, Command], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CollectorService_ServiceDesc.Streams[0], CollectorService_StreamMetrics_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MetricBatch, Command]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CollectorService_StreamMetricsClient = grpc.BidiStreamingClient[MetricBatch, Command]
...
type CollectorServiceServer interface {
	...
	// StreamMetrics allows a Probe to push metrics continuously via a bidirectional stream.
	// The Controller can also send commands back to the Probe via this stream.
	StreamMetrics(grpc.BidiStreamingServer[MetricBatch, Command]) error
...
func (UnimplementedCollectorServiceServer) StreamMetrics(grpc.BidiStreamingServer[MetricBatch, Command]) error {
...
func _CollectorService_StreamMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CollectorServiceServer).StreamMetrics(&grpc.GenericServerStream[MetricBatch, Command]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CollectorService_StreamMetricsServer = grpc.BidiStreamingServer[MetricBatch, Command]
...
var CollectorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.proto.CollectorService",
