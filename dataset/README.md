...
In `v0.7`, the RAG path no longer treats this directory as “random text to chunk.” It scans the dataset, classifies sources, normalizes them into SRE-oriented knowledge objects, and only then builds lexical/vector indexes.
